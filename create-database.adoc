...
.Antes de começar
Complete os seguintes pré-requisitos antes de criar um novo banco de dados.

* *Credenciais e permissões*: Você deve ter link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Credenciais da conta AWS e permissões de _operações e remediação_"^] para criar um novo banco de dados no Workload Factory.
+
