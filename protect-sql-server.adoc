...
---
= Proteja as cargas de trabalho do Microsoft SQL Server com o NetApp Workload Factory para Bancos de Dados
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
== Proteção contra edição para recursos do Microsoft SQL Server

Você pode editar a proteção para instâncias e bancos de dados do Microsoft SQL Server que já estão protegidos no NetApp Backup and Recovery. A proteção de edição permite modificar a política ou o agendamento de proteção para suas instâncias protegidas do SQL Server.
...
. Localize o banco de dados para o qual deseja editar a proteção e, em seguida, selecione *Editar proteção* no menu.
+
Você será redirecionado para Backup e Recuperação no NetApp Console , onde poderá modificar a política ou o agendamento de proteção.
