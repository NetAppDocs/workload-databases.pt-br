...
* *Credenciais e permissões*: Você precisa ter link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Credenciais da conta AWS e permissões de _visualização, planejamento e análise_"^] Para criar um clone de sandbox no Workload Factory.
+
