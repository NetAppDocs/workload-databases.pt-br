...
A implantação do Microsoft SQL Server em uma rede privada sem conetividade de saída usando o Terraform só é suportada na região US-East-1 (N. Virginia). O PostgreSQL não suporta o Amazon CloudWatch ou a implantação em uma rede privada.
